        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I believe technology should bridge people and solve real-world
                problems. My passion is crafting digital experiences that are
              ...
              >
                ...
                open source, and mentor developers.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <div className="grid gap-4">
                {(Array.isArray(PASSIONS) ? PASSIONS : []).map(
                  (passion, index) => {
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              <div className="flex justify-center">
                <img src={SIGNATURE} alt="Lanang" className="w-28" />
              </div>
            ...
            <div className="space-y-8">
              {JOURNEY_STEPS.map((step, index) => (
                ...
                >
                  ...
                  {/* Content */}
                  <div
                    className={`grow p-6 rounded-xl border backdrop-blur-sm transition-all duration-300 ${
                      isDarkMode
                        ? 'border-gray-700 bg-gray-800/50 group-hover:border-gray-600 group-hover:bg-gray-800/70'
                        : 'border-gray-200 bg-gray-50/80 group-hover:border-gray-300 group-hover:bg-white'
                    }`}
                  >
